...
--
/*!50003 DROP PROCEDURE IF EXISTS `cleanup_messages` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `cleanup_messages`()
BEGIN
	DELETE FROM messages WHERE messages.is_delivered = 1;
END ;;
DELIMITER ;
